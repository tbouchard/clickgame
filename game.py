...
game = Game("Spooky Spook Time")

# define and describe a couple of locations
deadend = game.new_location(
"Dead End {e}",
"""You and your friends stand outside the oldest house on your street. You recall there being rumors of this house being haunted, and you and your friends have come to investigate. You open the door, and are the first one to step inside. Suddenly the door slams behind you and out of no where, you see it lock behind you. You are trapped. You are alone. \n
You decide to look around the house. Maybe there's a way out, but not here. \n""")

tunnel = game.new_location(
"Hallway {e, w}",
"""You start down a long, narrow hallway. The air is cold and damp. The dust and cobwebs imply that this house hasn't been touched in years. Suddenly, you feel a burst of cold wind overcome you. YOu get the chills. Is your imagination getting the best of you? There's a bend up ahead, maybe it will lead you to an exit. \n""")

tunnelbend = game.new_location(
"A Bend in the Hallway {e, w}",
"""There is a bend in the hallway. You see a doll laying next to a stack of books. The books are old and dusty and all the titles are worn off. You see an intersection of paths ahead.\n""")

intersection = game.new_location(
"Tunnel Intersection {n,e,s,w}",
"""You turn the corner and are greeted with four options. A staircase goes upwards to another hallway and on either side of the staircase there is a door. The door on the right is cracked open. There is also a large wooden door on the ground, could it lead to the basement?\n
...
"Bathroom {n, e}",
"""You push past the boards and are greated with a bathroom. Though it looks old and broken, you turn on the sink. It's still fully functional. Since the house is covered in dust and spiderwebs, you bend down to wash your hands in the sink. Looking back up and into the mirror, your reflection is replaced with that of a beautiful woman. She stares at you longingly before letting out a blood curdling scream. Everything goes black.\n""")
player.terminate()

il_sl = game.new_location(
"Library {n , n}",
#I want this room to remain locked unless the player has the key to get in.
